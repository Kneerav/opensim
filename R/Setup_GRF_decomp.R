Setup_GRF_decomp = function(base_file = "Setup_IAA_base.xml",
                    ...
                    step_interval = "1",
                    in_degrees = "true",
                    kinetics_file = "GRF.mot",
                    forces_file = "Forces.sto",
                    force_threshold = "10",
                    weights = "10000 100 1",
                    footpoint_markers = "r_fp_heel1 r_fp_heel2 r_fp_mt1 r_fp_mt2 r_fp_toe l_fp_heel1 l_fp_heel2 l_fp_mt1 l_fp_mt2 l_fp_toe",
                    output_grf_contribution = "1",
  ...
  #step_interval
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//step_interval")
  XML::xmlValue(nodes[[1]]) = step_interval

  #in_degrees
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//in_degrees")
  XML::xmlValue(nodes[[1]]) = in_degrees

  #kinetics_file
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//kinetics_file")
  XML::xmlValue(nodes[[1]]) = kinetics_file

  #forces_file
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//forces_file")
  XML::xmlValue(nodes[[1]]) = forces_file

  #force_threshold
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//force_threshold")
  XML::xmlValue(nodes[[1]]) = force_threshold

  #weights
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//weights")
  XML::xmlValue(nodes[[1]]) = weights

  #footpoint_markers
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//footpoint_markers")
  XML::xmlValue(nodes[[1]]) = footpoint_markers

  #output_grf_contribution
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//IndAccPI//output_grf_contribution")
  XML::xmlValue(nodes[[1]]) = output_grf_contribution
